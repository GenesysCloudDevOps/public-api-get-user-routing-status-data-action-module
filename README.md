A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get User Routing Status
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-user-routing-status-data-action-module.git?ref=main"
    action_name        = "Get User Routing Status"
